...
export const ui = {
  zh: {
    ...
    'cat.emptyBody': '「臺灣橋樑計畫」邀請的 31 位得主中，沒有文學獎得主。展櫃暫時空著——但諾貝爾文學獎的故事仍然值得一讀。',
    'cat.emptyLink': '認識歷屆諾貝爾文學獎得主',
    'cat.aboutPrize': '關於這個獎項',
    'cat.materials': '延伸材料',
    'cat.materialsNote': '以下連結全部指向諾貝爾基金會官方網站，可查詢歷屆得主、得獎理由與統計資料。',
    'cat.asOf': '統計數字取自諾貝爾獎官方 API，資料日期 {date}。',

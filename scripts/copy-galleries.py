...
GALLERIES = {
"physics": dict(
  intro_zh="諾貝爾物理學獎頒給「對人類帶來最大貢獻」的物理發現或發明。從 X 光、放射性，到量子力學、宇宙加速膨脹與重力波——把歷屆名單讀完一遍，差不多就讀完了一部現代物理簡史。",
  ...
  history_zh="1901 年首屆頒給發現 X 射線的倫琴。此後曾六度從缺，大多落在兩次世界大戰期間。",
...
"chemistry": dict(
  intro_zh="化學獎表彰化學領域最重要的發現或改良。它的範圍比課本上的「化學」寬得多：週期表上的新元素、塑膠與藥物的合成，一直到解出生命分子的立體結構。",
  ...
  history_zh="1901 年首屆頒給研究化學動力學與滲透壓的范特荷夫。由於生命科學有很大一部分也是化學，這個獎常常頒給生物學家——那是它一場行之有年、也頗為和氣的爭論。",
...
"medicine": dict(
  intro_zh="這個獎表彰生理學或醫學上的重大發現。它記錄了人類如何一步一步看懂自己的身體：從細菌與抗生素、DNA 的雙螺旋，到免疫系統的運作與大腦如何為空間繪製地圖。",
  ...
  history_zh="1901 年首屆頒給以血清療法對抗白喉的貝林。獎項名稱裡「生理學或醫學」的並列是諾貝爾遺囑的原話，所以基礎研究與臨床治療都算數。",
...
"literature": dict(
  intro_zh="文學獎頒給「在文學領域創作出具理想傾向之最傑出作品」的作家。它是六個獎裡唯一表彰一整個創作生涯、而不是單一發現的獎——這也是每年最難預測結果的一個。",
  ...
  history_zh="1901 年首屆頒給法國詩人蘇利‧普魯東。得主由瑞典學院的十八位院士選出，提名紀錄保密五十年才會公開。",
...
"peace": dict(
  intro_zh="和平獎頒給為促進國家之間的友好、裁減軍備或推動和平會議付出最多努力的人或組織。它是六個獎中唯一由挪威委員會頒發的，也是唯一可以頒給一個組織、而不只是個人的獎。",
  ...
  history_zh="1901 年首屆由紅十字會創辦人杜南與和平運動者帕西共同獲得。它從缺的次數是六個獎中最多的——因為總有些年份，實在找不到可以頒的人。",
...
"economics": dict(
  intro_zh="它的全名是「瑞典中央銀行紀念阿佛烈‧諾貝爾經濟學獎」。這個獎並不在諾貝爾的遺囑裡，而是瑞典央行在 1968 年慶祝成立三百週年時設立的；不過評選工作同樣交給瑞典皇家科學院，和物理獎、化學獎一樣。",
  ...
  history_zh="1969 年首屆由弗里希與丁伯根共同獲得，表彰他們建立分析經濟過程的動態模型。它是六個獎中最年輕的一個，而且從未從缺。",

...
"geim": dict(
  ...
  summary_zh="你摸得到的每一樣東西都有三個維度——但蓋姆偏偏做出了只有一顆原子厚的材料：石墨烯。它極強韌、極導電，裡頭的電子跑起來像沒有質量，讓相對論可以在實驗桌上被看見。這堂課講的不是更貴的儀器，而是一個愛玩的念頭能走多遠。",
...
"karman": dict(
  ...
  summary_zh="卡曼提醒我們，永續從來不只是碳排放的問題。當戰爭摧毀生活、貧窮把人排除在外、利潤被放在人權之前，一個國家不可能真正成長。她主張的未來，要更乾淨，也要更公平、更能共享。",
...
"kornberg": dict(
  ...
  summary_zh="康柏格解開了細胞如何讀取基因、把訊息轉錄出來的分子細節——那是所有生命運作的第一步。從這個基礎出發，他在這堂課談生物醫學近年的爆炸性進展，以及當醫學真的走到那一步時，人類要面對什麼。",
...
"queloz": dict(
  ...
  summary_zh="奎洛茲與同事找到第一顆繞著類太陽恆星運行的系外行星，從此我們知道太陽系並不孤單。在這堂課裡，他把望遠鏡轉回地球，談科學社群如何跨越國界運作，以及這種合作方式能為全球議題帶來什麼。",
...
"murad": dict(
  ...
  summary_zh="穆拉德是戰爭性暴力的倖存者，她選擇把自己的經歷說出來，讓一件長期被沉默包圍的罪行被看見。這堂課談的是：個人的證詞如何成為國際行動的起點，而我們每一個人在其中能站在哪裡。",
...
"pissarides": dict(
  ...
  summary_zh="皮薩里德斯研究的是勞動市場如何媒合人與工作。他認為 AI 不會拿走每一份工作，而是拿走某些工作裡的某些部分；在判斷、溝通、照顧、臨場決策上，人仍然重要。真正的問題不在技術，而在人們能不能得到轉換跑道所需的訓練。",
...
"maskin": dict(
  ...
  summary_zh="今天的全球化不只是買賣，而是跨國分工：一個產品，很多工種，很多技能層級。高技能的工作接上了世界，低技能的沒有；於是經濟成長的同時，差距也一起長大。馬斯金的結論不是停止全球化，而是讓更多人具備坐上這張桌子的能力。",
...
"sudhof": dict(
  ...
  summary_zh="聚德霍夫解開了神經細胞之間如何在千分之一秒內精準傳遞訊號。這堂課他把焦點放在阿茲海默症、帕金森氏症這類神經退化疾病的用藥困境：不只是要開發得出來，還要開發得便宜、供得起、走得久。",
...
"ciechanover": dict(
  ...
  summary_zh="切哈諾沃發現了細胞如何標記並分解不需要的蛋白質——這套機制一旦出錯，就可能演變成癌症。他在這堂課談醫學正在離開「一體適用」：兩個人診斷相同，基因與體質卻不同，同一種藥可能有效、可能無效、也可能帶來嚴重副作用。",
...
"strickland": dict(
  ...
  summary_zh="GPS、網路、你手上的筆電，都來自需要很多年才做對的科學。疫情期間，科學第一次在所有人面前即時修正自己，有人把那叫做失敗。史崔克蘭說，那不是失敗，那正是科學在公開場合學習的樣子。",
...
"stiglitz": dict(
  ...
  summary_zh="史迪格里茲長期研究一件事：當買賣雙方掌握的資訊不一樣，市場會出什麼問題。他在這堂課處理一個更大的題目——「自由」到底是誰的自由，以及一個社會要怎麼安排規則，才能讓自由不只屬於最有力量的人。",
...
"haroche": dict(
  ...
  summary_zh="要測量一個量子系統，通常就會毀掉它。阿羅什設計出方法，能反覆觀察被困住的單顆光子而不將它摧毀，讓量子世界的怪異行為第一次被直接看見。這堂課從那裡出發，談雷射、量子光學與量子運算正在往哪裡去。",
...
"schmidt": dict(
  ...
  summary_zh="施密特的團隊測量遙遠的超新星，本來想知道宇宙膨脹減慢了多少，結果發現它反而在加速。這個沒人預期的答案，打開了暗能量的問題。他以此為例，談科學作為一種全人類共用的方法，能跨過多少界線。",
...
"mayor": dict(
  ...
  summary_zh="麥耶找到了第一顆繞著類太陽恆星的系外行星，從此我們知道銀河系裡有無數個世界。也正因為他最清楚那些世界有多遠、多不適合居住，他在這堂課給出一個冷靜的答案：沒有 B 行星，地球是我們唯一的家。",
...
"meldal": dict(
  ...
  summary_zh="梅爾達爾是「點擊化學」的奠基者之一：讓分子像扣子一樣快速、乾淨地扣在一起，減少廢棄物、耗能與副反應。這代表更好的製藥方式、更好的新材料，以及真正精準地造出想要的分子。他留下的挑戰很簡單——不是做更多，而是做得更好。",
...
"engle": dict(
  ...
  summary_zh="恩格爾發明了衡量金融市場「波動會群聚」的方法，成為風險管理的基礎工具。他把同一套思路轉向氣候：如果乾旱、洪水與政策轉向都會衝擊資產價格，那麼氣候風險就是財務風險，而且是現在就該定價的風險。",
...
"roberts": dict(
  ...
  summary_zh="羅伯茨發現基因並不是一段連續的文字，中間夾著必須被剪掉的片段——這個發現改寫了我們對基因如何運作的理解。在這堂課，他直接處理一個爭議話題：他認為對基改作物的恐懼，正在讓最需要糧食的人付出代價。",
...
"mbmoser": dict(
  ...
  summary_zh="在大腦的內嗅皮質裡，有一群神經細胞會以規律的網格形式放電，幫你知道自己在哪裡、要往哪裡去，也把空間和記憶連在一起。莫瑟指出，這套系統在阿茲海默症的早期就會受損——所以失去的不只是方向感，還有你記得的那個世界。",
...
"nurse": dict(
  ...
  summary_zh="納斯找到了控制細胞何時分裂的關鍵開關——這套機制從酵母菌到人類幾乎完全相同，也正是癌症研究的核心。他用一生累積的答案，回到那個最原始的問題：到底什麼才算活著？",
...
"winter": dict(
  ...
  summary_zh="溫特找到辦法，讓實驗室能像演化一樣，一輪一輪篩選出愈來愈精準的抗體。今天許多治療癌症與自體免疫疾病的藥物，都是這樣造出來的。這堂課講的就是這場從免疫學走進藥局的革命。",
...
"mcdonald": dict(
  ...
  summary_zh="太陽送來的微中子，我們只數到預期的三分之一，這個謎題困擾了物理學家三十年。麥克唐納在地底深處的實驗證明：它們沒有消失，只是變身了——而這代表微中子有質量，粒子物理的標準模型並不完整。",
...
"noyori": dict(
  ...
  summary_zh="很多分子有兩種互為鏡像的形式，就像左手與右手——在人體內，往往只有一種有用，另一種可能有害。野依良治開發出催化劑，能選擇性地只造出想要的那一隻手。他認為化學的價值，就在於此。",
...
"emoser": dict(
  ...
  summary_zh="莫瑟與研究團隊發現了「網格細胞」：它們在大腦裡鋪出一張規律的座標網，讓你在移動時始終知道自己的位置。這是大腦替空間建立地圖的方式，也是記憶得以附著其上的骨架。",
...
"rice": dict(
  ...
  summary_zh="C 型肝炎曾經在全球感染數千萬人，最後導致肝硬化與肝癌。萊斯的研究讓這個病毒第一次能在實驗室裡被完整培養，直接打開了治癒藥物的大門。他以這個成功為起點，談人類面對下一場傳染病時還缺什麼。",
...
"wuthrich": dict(
  ...
  summary_zh="蛋白質的形狀決定它的功能，但它太小，看不見。維特里希開發出用核磁共振在溶液中解出蛋白質三維結構的方法——也就是在接近生命實際狀態的環境下觀察它。這堂課談這條路如何一路走到今天的 AI 結構預測。",
...
"semenza": dict(
  ...
  summary_zh="塞門薩找到了細胞感測氧氣濃度的分子開關：缺氧時，它會啟動一整套反應，例如長出新血管。這套機制關係到貧血、心血管疾病，也被腫瘤拿來為自己開路。他從這裡談起氧氣、二氧化碳與地球生命的長期平衡。",
...
"roth": dict(
  ...
  summary_zh="腎臟不能買賣，學校名額也不該標價，但這些配對還是得做，而且做得好不好會決定有沒有人活下來。羅斯把經濟學變成一種設計工作：重新設計規則本身，讓捐贈者與病患能配對成功。這套方法已經真的在救人。",
...
"kobilka": dict(
  ...
  summary_zh="細胞表面有一群受體，負責把外界的訊號傳進細胞裡；市面上大約三分之一的藥物都作用在它們身上。科比爾卡拍下了這些受體在傳遞訊號那一瞬間的立體結構，讓藥物設計從碰運氣，變成看著標靶下手。",
...
"kajita": dict(
  ...
  summary_zh="梶田隆章證明微中子會在飛行途中改變身分——這代表它們有質量，而粒子物理原本認為沒有。這項發現需要跨國、跨世代的合作才能完成，他也因此在這堂課談科學合作本身，如何成為建立和平的一種方式。",
...
"frank": dict(
  ...
  summary_zh="法蘭克發展出影像處理方法，把成千上萬張模糊的電子顯微鏡照片，組合成生物分子清晰的立體結構。加上急速冷凍技術，我們第一次能看見蛋白質在接近自然狀態下的樣子——這已經成為現代藥物設計的基礎。",
